...
module TD::ClientMethods
  ...
  # Then, stories are returned in a reverse chronological order (i.e., in order of decreasing story_id).
  # For optimal performance, the number of returned stories is chosen by TDLib.
  #
  # @param chat_id [Integer] Chat identifier.
  # @param from_story_id [Integer] Identifier of the story starting from which stories must be returned; use 0 to get
  ...
  # The method can be called if message.can_get_read_date == true and the message is read.
  #
  # @param chat_id [Integer] Chat identifier.
  # @param message_id [Integer] Identifier of the message.
  ...
  def get_star_transactions(owner_id:, direction:, offset:, limit:)
  ...
  # The message must be successfully sent, must not be scheduled, and must be from a non-secret chat.
  #
  # @param chat_id [Integer] Identifier of the chat to which the message belongs.
  # @param message_id [Integer] Identifier of the message.
  # @return [TD::Types::Ok]
  ...
  #   notification for the iOS application; pass an empty string to abort verification and receive error VERIFICATION_FAILED
  #   for the request.
  # @return [TD::Types::Ok]
  ...
  # Can be only used if getOption("can_edit_fact_check") == true.
  #
  # @param chat_id [Integer] The channel chat the message belongs to.
  # @param message_id [Integer] Identifier of the message.
  #   The message must be one of the following types: messageAnimation, messageAudio, messageDocument, messagePhoto,
  #   messageText, messageVideo.
