module TD::Types
  ...
  # A share screen needs to be shown to the user, then the chosen chat should be open and the text should be added to
  #   the input field.
  #
  ...
  #   If true, the input field needs to be focused and the text after the link should be selected.
