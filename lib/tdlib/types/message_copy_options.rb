module TD::Types
  ...
  # Service messages, messages with messageInvoice, messagePaidMedia, messagePremiumGiveaway, or
  ...
  # @attr new_show_caption_above_media [Boolean] True, if new caption must be shown above the animation; otherwise, new
